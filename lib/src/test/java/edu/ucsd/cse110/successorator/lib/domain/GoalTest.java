...
public class GoalTest {
    ...
    public void testEquals(){
        Goal goal1 = new Goal("Study midterm", 1, true, 1);
        Goal goal2 = new Goal("Study midterm", 1, true, 1);
        Goal goal3 = new Goal("Don't study", 1, true, 1);
    ...
    public void testWithId(){
        Goal goal = new Goal("Study midterm", 1, true, 1);
        Goal expected = new Goal("Study midterm", 2, true, 1);
    ...
    public void testWithSortOrder(){
        Goal goal = new Goal("Study midterm", 1, true, 1);
        Goal expected = new Goal("Study midterm", 1, true, 5);
    ...
    public void testWithComplete(){
        Goal goal = new Goal("Study midterm", 1, true, 1);
        Goal expected = new Goal("Study midterm", 1, false, 1);
