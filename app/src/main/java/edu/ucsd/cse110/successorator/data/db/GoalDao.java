...
public interface GoalDao {
    ...
    @Query("UPDATE flashcards SET sort_order = sort_order + :by " + "WHERE sort_order >= :from AND sort_order <= :to")
    ...
    @Transaction
    default int append(FlashcardEntity flashcard) {
    ...
    @Transaction
    default int prepend(FlashcardEntity flashcard) {
